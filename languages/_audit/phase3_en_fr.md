...
- Deduped programmatically: every English target (`word_2`) appears once across all five files. Words colliding with a1/a2 (e.g. _to travel, society, government, reason, dangerous, possible, finally, approach, benefit, risk_) were dropped and replaced with fresh non-colliding level-appropriate words.
