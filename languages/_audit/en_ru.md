...
Coverage note: the corpus over-indexes on **concrete nouns (A1/A2)** and **abstract Latinate nouns (B1–C1)**, and is critically **short on verbs, adjectives, and adverbs at every level**. There are almost no common verbs anywhere. This is the biggest gap. b1 (138), b2 (162), c1 (145) are also numerically underpopulated relative to a1/a2 - they need backfill, but with the _right_ parts of speech rather than more abstract nouns.
