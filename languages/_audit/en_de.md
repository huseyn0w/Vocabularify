...
**Consequence:** b1/b2/c1 were dimensioned and word-selected for _teaching German to English speakers_,
then reversed. That word list is **not** frequency-/difficulty-tuned for _teaching English to Germans_.
...
the columns are swapped; the _content_ is the same vocabulary.)
...
_Generated by audit. No dictionary JSON was modified._
